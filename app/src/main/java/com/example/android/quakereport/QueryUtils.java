...
public final class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            JSONObject rawEarthquakes = new JSONObject(SAMPLE_JSON_RESPONSE);
            JSONArray features = rawEarthquakes.getJSONArray("features");
            ...
            for(int i=0; i<features.length(); i++) {
                ...
                Earthquake newEarthquake = new Earthquake(mag, loc, time);
